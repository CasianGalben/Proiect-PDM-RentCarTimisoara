...
public class RentalView extends JFrame{
    ...
    public RentalView() {
        ...
        ImageIcon titleImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\Intro.GIF");
        ...
        Integer[] currentYearCB = {2020, 2021, 2022, 2023, 2024, 2018, 2025,2026};
        cYCB = new JComboBox(currentYearCB);
        cYCB.setBounds(490, 240, 60, 25);
        mainP.add(cYCB);

        //------------------------------------BUTTONS to go reserve section
        ImageIcon mainNextImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\next.GIF");
        ...
        Integer[] pickUpYearCB = {2020, 2021, 2022, 2023, 2024, 2018, 2025,2026};
        ...
        Integer[] returnYearCB = {2020, 2021, 2022, 2023, 2024, 2018, 2025,2026};
        ...
        Integer[] birthYearCB = {1963,1964,1965,1966,1967,1968,1969,
        ...
        ImageIcon dateNextImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\customer.GIF");
        ...
        ImageIcon dateBackImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\customer_back.GIF");
        ...
        ImageIcon customerNextImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\next.GIF");
        ...
        ImageIcon customerBackImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\back.GIF");
        ...
        //---------------------------------------------------------Pick Car Buttton]
        //-------------------------------------first car button
        ImageIcon firstCarImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\van.gif");
        ...
        //---------------------------------second car button
        ImageIcon secondCarImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\pickup.GIF");
        ...
        //---------------------------------------third car button
        ImageIcon thirdCarImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\jeepney.gif");
        ...
        //------------------------------------------forth car button
        ImageIcon forthCarImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\limousine.gif");
        ...
        //-------------------------------------------------to go receipt section
        ImageIcon carNextImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\car.GIF");
        ...
        ImageIcon carBackImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\car_back.GIF");
            ...
            if(event.getActionCommand().equals("NextToCustomer")) {
                ...
                if(aTrans.toStringDateChecker().equals("TRUE") && aTrans.toStringAgeChecker().equals("TRUE")) { //checker to proceed next panel
                    ...
                    if(openWarningReserve == null){
                        ...
                        ImageIcon warningReserveImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\warning_top_icon.GIF");
            ...
            if(event.getActionCommand().equals("NextToPickCar")) {
                ...
                if(!aCustomer.getFirstName().equals("Type First Name Here") && !aCustomer.getLastName().equals("Type Last Name Here") && !aCustomer.getGender().equals("M/F") && !aCustomer.getStatus().equals("S/Ma") && !aCustomer.getLocation().equals("Type Complete Address Here") && !aCustomer.getContact().equals("Type Contact Number Here")){
                    ...
                    if(openWarningCustomer == null){
                        ...
                        ImageIcon warningCustomerImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\warning_top_icon.GIF");
    ...
    private class secondCarButton implements ActionListener{
        public void actionPerformed(ActionEvent event) {

            carDetailsTA.setText("");
            carDetailsTA.setText("Brand: Toyota\nPlate #: TM 07 GBM\nType: Corolla\nModel:2014\nColor:  White\nRental Price: P600.00\n\n-Italy \n-KM:0 \n-New ");
    ...
    private class thirdCarButton implements ActionListener{
        public void actionPerformed(ActionEvent event) {
            ...
            carDetailsTA.setText("");
            carDetailsTA.setText("Brand: Jeep\nPlate #: TM 09 GBM\nType: Jeep\nModel: 2014\nColor: Blue\nRental Price: P250.00\n\n-Germany \n-KM:100.000 \n-Used ");
    ...
    private class forthCarButton implements ActionListener{
        public void actionPerformed(ActionEvent event) {
            ...
            carDetailsTA.setText("");
            carDetailsTA.setText("Brand: Mercedes-Benz\nPlate #: TM 01 BNZ\nType: limousine\nModel: 2015\nColor: Black\nRental Price: P650.00\n\n-Germany \n-KM:21.000 \n-Used ");
    ...
    private class finalStepButton implements ActionListener{
        public void actionPerformed(ActionEvent event) {
            ...
            if(event.getActionCommand().equals("Car1")) { //passing the pick-up details to car details class and final transactions.
                ...
                String carType = "Nissan", carModel = "2015";
                ...
                String carType = "Toyota", carModel = "2014";
                double carPrice = 600.00;
                ...
                String carType = "Jeep", carModel = "2014";
                ...
                String carType = "Mercedes-Benz", carModel = "2015";
                double carPrice = 650.00;
                ...
                if(openWarningCar == null){
                    ...
                    ImageIcon warningCarImage = new ImageIcon("C:\\Users\\fifa_\\OneDrive\\Desktop\\Rental\\Car Rental Galben Casian\\images\\warning_top_icon.GIF");
